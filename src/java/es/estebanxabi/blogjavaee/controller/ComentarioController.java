...
import es.estebanxabi.blogjavaee.facade.ComentarioFacade;
...
public class ComentarioController implements Serializable {
    ...
    @EJB
    private es.estebanxabi.blogjavaee.facade.ComentarioFacade ejbFacade;
    ...
    public List<Comentario> getComentariosPost(Post post) {
        return ejbFacade.getComentariosPost(post);
    }
